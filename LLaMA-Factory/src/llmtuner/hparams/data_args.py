...
class DataArguments:
    ...
    use_only_last_turn: Optional[bool] = field(
        default=False,
        metadata={"help": "Only train on the last response."}
    )
    group_by_prompt: Optional[bool] = field(
        default=False,
        metadata={"help": "Group data by prompt."}
    )
